  ...
  const subscriptionTiers: SubscriptionTier[] = [
    {
      ...
      name: "Basic",
      price: 14.99,
      features: ["Miranda Rights delivery", "Basic statute lookups", "Voice activation", "24/7 availability"],
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {subscriptionTiers.map((tier) => (
            ...
            >
              {tier.recommended && (
                <div className="bg-blue-600 text-white text-center py-1 text-sm font-medium">RECOMMENDED</div>
              )}
              <CardHeader>
              ...
              <CardFooter>
                <Button
                  ...
                  className={`w-full ${
                    tier.recommended ? "bg-blue-600 hover:bg-blue-500" : "bg-blue-800 hover:bg-blue-700"
                  }`}
                >
