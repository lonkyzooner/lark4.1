...
import { useSubscription, type SubscriptionPlan } from "../services/subscription/SubscriptionService"
    ...
    return (
      <div className="container mx-auto py-8 px-4">
        <div className="text-center">
          ...
          <div className="p-4 bg-red-100 text-red-800 rounded-md mb-4">{error.message}</div>
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="mb-12">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{subscriptionTier.charAt(0).toUpperCase() + subscriptionTier.slice(1)} Plan</CardTitle>
            <CardDescription>
              Status:{" "}
              <span
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {plans.map((plan) => (
            <Card key={plan.id} className={`${plan.tier === subscriptionTier ? "border-2 border-blue-500" : ""}`}>
              <CardHeader>
              ...
              <CardFooter>
                <Button
                  ...
                  disabled={isLoading || processingPlanId === plan.id || plan.tier === subscriptionTier}
