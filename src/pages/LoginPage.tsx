    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-900 to-blue-950">
      <Card className="w-full max-w-md mx-auto bg-white/10 backdrop-blur-md text-white border-blue-700">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-blue-200">Law Enforcement Assistance and Response Kit</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2 text-center">
            <h3 className="text-xl font-semibold">Welcome</h3>
            <p className="text-sm text-blue-200">Sign in to access your LARK assistant</p>
          </div>

          {isLoading ? (
            <div className="text-center py-4">Loading authentication...</div>
          ) : isAuthenticated ? (
            <div className="text-center py-4">You are already authenticated. Redirecting...</div>
          ) : (
            <div className="space-y-4">
              ...
              <Button className="w-full bg-blue-700 hover:bg-blue-600" onClick={handleLogin}>
                Sign in with Auth0
              </Button>
        ...
        <CardFooter className="flex justify-center border-t border-blue-800 pt-4">
          <p className="text-xs text-blue-300">© 2025 LARK - Secure Authentication</p>
        </CardFooter>
      </Card>
    </div>
  )
