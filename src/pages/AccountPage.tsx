                      ...
                      <div className="bg-blue-900/30 rounded-lg p-4 border border-blue-800/50">
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-blue-300 mt-1">${subscriptionDetails?.amount}/month</p>
                          </div>
                        ...
                        <div className="mt-4 pt-4 border-t border-blue-800/30">
                          <p className="text-blue-300 text-sm">
                            Next billing date:{" "}
                            {subscriptionDetails?.nextBillingDate && formatDate(subscriptionDetails.nextBillingDate)}
                          </p>
                        </div>
                      </div>
                    )}
              ...
              <Card className="bg-blue-950/50 border-blue-800/50">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="bg-blue-900/30 rounded-lg p-4 border border-blue-800/50">
                      <p className="text-blue-300 text-center py-4">No payment methods on file</p>
                  ...
                  <div>
                    ...
                    <div className="bg-blue-900/30 rounded-lg p-4 border border-blue-800/50">
                      <p className="text-blue-300 text-center py-8">No billing history available</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
