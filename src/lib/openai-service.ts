      ...
      messages: [
        {
          role: "system",
          content:
            "You are LARK, a police officer's AI assistant, operating like JARVIS from Iron Man. You process voice commands, provide translations, and return structured responses in a professional yet conversational manner.",
        },
      ...
      messages: [
        {
          role: "system",
          content:
            "You are LARK's legal module, operating like JARVIS from Iron Man. You specialize in Louisiana law and can provide translations of legal terms and concepts while maintaining a professional yet conversational tone.",
        },
        { role: "user", content: prompt },
      ],
    })
    ...
    messages: [
      {
        role: "system",
        content:
          "You are LARK's threat assessment module, operating like JARVIS from Iron Man. Provide clear, actionable threat assessments while maintaining a professional yet conversational tone. You can translate threats described in other languages when needed.",
      },
      { role: "user", content: prompt },
    ],
    temperature: 0.7,
