import type { CommandResponse } from "./openai-service"
...
const COMMON_STATUTES = {
  "14:30":
    "First degree murder - the killing of a human being when the offender has specific intent to kill or to inflict great bodily harm.",
  "14:95": "Illegal carrying of weapons - unlawful carrying of a concealed weapon by a person.",
  "14:402":
    "Prohibited items in correctional facilities - introduction or possession of contraband in any jail, prison, correctional facility, or institution.",
}
...
export async function processOfflineCommand(
  transcript: string,
  context?: { location?: string; timeOfDay?: string; previousCommand?: string },
