...
const commandPatterns = {
  miranda: [/read.*miranda.*rights/i, /miranda.*rights/i, /rights.*miranda/i, /read.*rights/i],
  statute: [/statute.*(\d+:\d+)/i, /look.*up.*statute.*(\d+:\d+)/i, /what.*is.*statute.*(\d+:\d+)/i],
  threat: [/check.*threat/i, /assess.*threat/i, /scan.*area/i, /threat.*assessment/i],
  tactical: [/tactical.*situation/i, /situation.*report/i, /tactical.*assessment/i],
}
