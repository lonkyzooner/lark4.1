...
import { getGeneralKnowledge } from "../lib/openai-service"
  ...
  return (
    <div className="bg-black/90 rounded-lg p-4 border border-blue-500/30">
      <div className="flex justify-between items-center mb-4">
        ...
        <Badge className="bg-blue-900/40 text-blue-300">Law Enforcement Tools</Badge>
      </div>
        ...
        <TabsContent value="interview" className="space-y-4 mt-0">
          <Card className="bg-blue-950/10 border-blue-900/30">
            <CardHeader className="pb-2">
              ...
              <CardDescription className="text-blue-400/70 text-xs">Voice-guided interview template</CardDescription>
            </CardHeader>
              ...
              {generatedReport && (
                <div className="rounded border border-blue-900/50 bg-black/70 p-3 mt-2">
                  ...
                  <div className="max-h-[300px] overflow-y-auto">
                    <div className="text-white/90 text-sm whitespace-pre-line">{generatedReport}</div>
                  </div>
                </div>
              )}
            </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="bg-blue-950/10 border-blue-900/30">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-blue-400/70 text-xs">Scan or enter plate number</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 pb-2">
                <div className="flex gap-2">
                  ...
                  />
                  <Button size="icon" variant="outline" className="bg-blue-900/30 border-blue-900/50">
                ...
                <Button
                  ...
                  className="w-full bg-blue-700 hover:bg-blue-800"
                >
                  {isProcessing ? <LoaderIcon className="h-4 w-4 animate-spin" /> : "Lookup Plate"}
                </Button>
            ...
            <Card className="bg-blue-950/10 border-blue-900/30">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-blue-400/70 text-xs">Scan IDs and documents</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 pb-2">
                {!showScanner && !scannedDocument && (
                  <div className="border-2 border-dashed border-blue-900/30 rounded-lg p-6 flex flex-col items-center justify-center gap-2">
                    ...
                    <p className="text-blue-400/70 text-xs text-center">Tap button below to scan ID or document</p>
                  </div>
                )}
                ...
                <Button onClick={scanDocument} disabled={isProcessing} className="w-full bg-blue-700 hover:bg-blue-800">
                  {isProcessing ? (
                    <>
                      <LoaderIcon className="h-4 w-4 mr-1 animate-spin" /> Processing...
                    </>
                    ...
                    <>
                      <ScanLineIcon className="h-4 w-4 mr-1" />{" "}
                      {scannedDocument ? "Scan New Document" : "Scan Document"}
                    </>
                  )}
                </Button>
              </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="bg-blue-950/10 border-blue-900/30">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-blue-400/70 text-xs">Check crimes and applicable laws</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 pb-2">
                ...
                {statuteResult && (
                  <div className="rounded border border-blue-900/50 bg-black/70 p-3 mt-2 max-h-[300px] overflow-y-auto">
                    <div className="text-white/90 text-sm whitespace-pre-line">{statuteResult}</div>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <Card className="bg-blue-950/10 border-blue-900/30">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-blue-400/70 text-xs">Get relevant legal precedents</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 pb-2">
                <div className="space-y-2">
                ...
                {caseLawResult && (
                  <div className="rounded border border-blue-900/50 bg-black/70 p-3 mt-2 max-h-[300px] overflow-y-auto">
                    <div className="text-white/90 text-sm whitespace-pre-line">{caseLawResult}</div>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <Card className="bg-blue-950/10 border-blue-900/30">
              ...
              <CardContent className="space-y-3 pb-2">
                ...
                {forcePolicyResult && (
                  <div className="rounded border border-blue-900/50 bg-black/70 p-3 mt-2 max-h-[300px] overflow-y-auto">
                    <div className="text-white/90 text-sm whitespace-pre-line">{forcePolicyResult}</div>
                  </div>
                )}
              </CardContent>
            </Card>
          ...
          <Card className="bg-blue-950/10 border-blue-900/30">
            ...
            <CardContent className="space-y-3 pb-2">
              <div className="flex gap-2">
                ...
                >
                  {isProcessing ? <LoaderIcon className="h-4 w-4 animate-spin" /> : "Load Map"}
                </Button>
              </div>
