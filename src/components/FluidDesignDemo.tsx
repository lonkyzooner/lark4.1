...
import { ShieldIcon, UserIcon, MenuIcon, ZapIcon, BellIcon } from "lucide-react"
    ...
    <div className="fluid-background min-h-screen">
      ...
      <header className="flex justify-between items-center p-6 relative z-10">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a href="#" className="text-[var(--evoke-text)] hover:text-[var(--evoke-dark-blue)] transition-colors">
            Our Work
          </a>
          <a href="#" className="text-[var(--evoke-text)] hover:text-[var(--evoke-dark-blue)] transition-colors">
            Pricing
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="rounded-full bg-black text-white px-4 py-2 text-sm font-medium">See Pricing</Button>
            ...
            <nav className="space-y-2">
              <button
                className={`w-full text-left p-3 rounded-lg transition flex items-center ${
                  activeTab === "dashboard" ? "le-blue-accent" : "hover:bg-white/60"
                }`}
              ...
              <button
                className={`w-full text-left p-3 rounded-lg transition flex items-center ${
                  activeTab === "threats" ? "le-blue-accent" : "hover:bg-white/60"
                }`}
              ...
              <button
                className={`w-full text-left p-3 rounded-lg transition flex items-center ${
                  activeTab === "alerts" ? "le-blue-accent" : "hover:bg-white/60"
                }`}
        ...
        <div className="md:col-span-2">
          ...
          <div className="fluid-card p-6">
            ...
            <div className="flex gap-4">
              <Input className="fluid-input flex-1" placeholder="Enter a command or ask a question..." />
              <Button className="fluid-button">Send</Button>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 mt-1">
                    Scanning complete. No immediate threats detected in your vicinity. All systems operating normally.
                  </div>
                </div>
              </div>
            </div>
