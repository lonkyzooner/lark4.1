      ...
      {activeTab === "overview" && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <CommandTypeCard title="Total Commands" count={stats.totalCommands} icon="📊" color="text-blue-400" />
            <CommandTypeCard
        ...
        <div className="space-y-6">
          <div className="bg-gray-800 p-4 rounded-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="px-3 py-1 bg-blue-600 rounded-full text-sm">OpenAI Voice</div>
            </div>
          ...
          <div className="bg-gray-800 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-3 bg-gray-700 rounded">
                ...
                <p className="text-2xl font-bold text-white mt-1">{Math.round(stats.averageResponseTime)}ms</p>
              </div>
              <div className="p-3 bg-gray-700 rounded">
                <p className="text-gray-400">Success Rate</p>
                <p className="text-2xl font-bold text-white mt-1">{Math.round(stats.successRate)}%</p>
              </div>
              <div className="p-3 bg-gray-700 rounded">
