...
import { openAIVoiceService, type SynthesisState, type VoiceSynthesisEvent } from "../services/voice/OpenAIVoiceService"
import { LoaderIcon, VolumeIcon, StopCircleIcon, AlertCircleIcon, CheckCircleIcon } from "lucide-react"

// Sample text for demonstration
const SAMPLE_TEXT =
  "Hello, I'm LARK, your Law Enforcement Assistant for Reconnaissance and Knowledge. How can I help you today?"
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            onClick={() =>
              setText(
                "Tactical situation assessment: Three suspects observed at the north entrance. Proceed with caution and maintain visual contact. Backup units are en route to your location.",
              )
            }
            className="text-xs bg-blue-900/30 hover:bg-blue-900/50 text-blue-300 px-2 py-1 rounded"
            disabled={isSpeaking}
