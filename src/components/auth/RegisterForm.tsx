  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center">Enter your information to create your LARK account</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {error && (
          <div className="p-3 text-sm bg-red-100 border border-red-200 text-red-800 rounded-md">{error.message}</div>
        )}
