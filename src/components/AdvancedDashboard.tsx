...
import { Activity, Mic, Brain, BarChart, CheckCircle2, Clock, Wifi, WifiOff } from "lucide-react"
              ...
              <div className="space-y-3">
                {stats.commonFailures.map((failure, index) => (
                  <div key={index} className="flex items-center justify-between p-2 bg-[#3a3a3c] rounded-lg">
                    ...
                    <Badge variant="destructive">{((failure.count / stats.totalCommands) * 100).toFixed(1)}%</Badge>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-[#2c2c2e] p-6 rounded-xl">
              ...
              <div className="relative pt-1">
                <div className="flex mb-2 items-center justify-between">
                  <Badge className="bg-[#30d158] text-white">{learningStats.learningProgress}% Complete</Badge>
                </div>
