...
export function VoiceAssistant() {
  ...
  const handleCommand = useCallback(
    async (command: string) => {
      ...
      if (commandLower === lastCommandRef.current && now - lastCommandTimeRef.current < 2000) {
      ...
      try {
        ...
        switch (response.action) {
          ...
          case "threat":
            ...
            document.dispatchEvent(
              new CustomEvent("triggerThreatScan", {
          ...
          case "statute":
            ...
            document.dispatchEvent(
              new CustomEvent("triggerStatuteLookup", {
          ...
          case "tactical":
            ...
            document.dispatchEvent(
              new CustomEvent("updateTacticalDisplay", {
        ...
        const urgencyPrefix = settings.voicePreferences.urgencyLevels ? getUrgencyPrefix(response.action) : ""
      ...
      <div className="p-6">
        <div className="bg-[#1c1c1e] rounded-xl p-6 border border-[#2c2c2e] shadow-lg">
          ...
          <p className="text-[#8e8e93] mb-4">
            Your browser doesn't support speech recognition. LARK requires a modern browser with speech recognition
            capabilities.
          </p>
    ...
    <div className="p-0 h-[530px] relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p style={{ marginBottom: "1.5rem", color: "#8e8e93" }}>
            LARK needs access to your microphone to listen for voice commands. Without this permission, voice
          ...
          <p style={{ marginTop: "1rem", fontSize: "0.875rem", color: "#8e8e93" }}>
            You can also manually enable microphone access in your browser settings.
          </p>
        </div>
      </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className={`rounded-full h-9 px-4 border-0 transition-all ${
                isActive
            ...
            <div className="h-full min-h-[340px] flex items-center justify-center flex-col gap-4">
              ...
              <div className="text-center max-w-xs">
                ...
                <p className="text-sm mt-2 text-[#8e8e93]">
                  Ask me anything about law enforcement, procedures, or legal questions.
                </p>
              </div>
            </div>
          ) : (
                ...
                <div className="flex justify-start">
                  ...
                  <div className="bg-[#2c2c2e] text-white rounded-2xl rounded-tl-none px-4 py-3 shadow-lg shadow-black/5">
                    <div className="flex items-center gap-2 h-6">
                      ...
                      {(latestAction === "general_query" || !latestAction) && (
                        <BrainIcon className="h-4 w-4 text-[#0a84ff]" />
                      )}

                      <div className="flex items-center space-x-1">
                        <span className="w-2 h-2 rounded-full bg-[#0a84ff] animate-bounce"></span>
                        <span
                          className="w-2 h-2 rounded-full bg-[#0a84ff] animate-bounce"
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-[#2c2c2e] backdrop-blur-md bg-[#1c1c1e]/70">
        <div className="flex items-center relative">
          ...
          {isActive && !listening && !isProcessing && (
            <Button className="ml-2 rounded-full h-10 w-10 p-0 bg-[#0a84ff] hover:bg-[#419cff] border-0 text-white shadow-lg shadow-[#0a84ff]/20">
