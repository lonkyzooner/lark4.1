...
class SubscriptionService {
   ...
   */
  public async createCustomerPortalSession(token: string, returnUrl: string): Promise<string> {
    try {
   ...
   */
  public async cancelSubscription(token: string, atPeriodEnd = true): Promise<boolean> {
    try {
