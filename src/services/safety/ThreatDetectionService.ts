...
class ThreatDetectionService {
  ...
  private threatSignatures = [
    {
      type: "gunshot",
      patterns: [
        /* frequency patterns for gunshots */
      ],
    },
    {
      type: "breaking_glass",
      patterns: [
        /* frequency patterns for breaking glass */
      ],
    },
    {
      type: "scream",
      patterns: [
        /* frequency patterns for screams */
      ],
    },
    {
      type: "aggressive_voice",
      patterns: [
        /* frequency patterns for aggressive voices */
      ],
    },
  ]
  ...
  private getSensitivityThreshold(): number {
    switch (this.options.sensitivity) {
      case "low":
        return 200 // Higher threshold, less sensitive
      case "high":
        return 150 // Lower threshold, more sensitive
      case "medium":
      default:
        return 175
    }
