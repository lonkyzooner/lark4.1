          ...
          messages: [
            {
              role: "system",
              content:
                "You are a law enforcement threat detection system. Analyze audio for potential threats like gunshots, raised voices, or concerning language. Provide a structured response with identified threats and a brief summary.",
            },
            {
              role: "user",
              content: prompt,
          ...
          messages: [
            {
              role: "system",
              content:
                "You are LARK (Law Enforcement Assistance and Response Kit), a body-mounted AI assistant for solo police officers. Provide concise, helpful responses to officer commands and questions. Focus on safety, clarity, and actionable information.",
            },
            {
              role: "user",
