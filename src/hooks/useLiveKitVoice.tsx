...
import type { SynthesisState } from "../services/livekit/LiveKitVoiceService"
...
export const useLiveKitVoice = () => {
  ...
  const speak = useCallback(async (text: string, voice?: string) => {
    ...
    try {
      ...
      console.log(
        `[useLiveKitVoice] Speaking text (${voice || "default voice"}): ${text.substring(0, 50)}${text.length > 50 ? "..." : ""}`,
      )
